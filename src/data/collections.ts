export const collections = {
  ...
  "knitwear-essentials": {
    ...
    sections: [
      ...
      },
      {
        title: "Bottomwear",
        products: [
          { name: "Regular Fit Pants", image: "/images/Knitwear/9.Regular Fit Pants.png" },
          { name: "Loose Fit Pants", image: "/images/Knitwear/10.Loose Fit Pants.png" },
          { name: "Regular Fit Shorts", image: "/images/Knitwear/11.Regular Fit Shorts.png" },
          { name: "Relaxed Fit Shorts", image: "/images/Knitwear/12.Relaxed Fit Shorts.png" }
        ]
      }
    ]
  },
  ...
  "dutchwhite": {
    title: "DUTCHWHITE",
    description: "Our associated premium fashion brand. Modern aesthetics meeting manufacturing precision.",
    image: "/images/DutchWhite/dutchwhite_font.png",
    sections: [
      {
        title: "Brand Identity",
        products: [
          { name: "Signature Collection", image: "/images/DutchWhite/dutchwhite_logo.png" }
        ]
      }
    ]
  }
